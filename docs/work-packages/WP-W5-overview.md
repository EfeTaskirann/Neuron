...
| WP-W5-06 | FSM deprecation + 435-test migration + final integration smoke (replace `swarm:run_job` with the brain dispatcher; remove `coordinator::fsm`) | sub-agent (general-purpose) | **shipped 2026-05-10 (`b484065` + `869e037` + `2bff4e5` + `fdf95ff` + `ddca3e5`); cargo 446/0/13 verified, FSM deleted (−7324 LOC), real-claude smokes #[ignore]'d for owner manual run** | WP-W5-04 ✅, WP-W5-05 ✅ | L |
